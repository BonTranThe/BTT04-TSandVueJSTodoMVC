...
export default defineComponent({
  ...
  methods: {
    ...
    toggleTickAll() {
      const todos2: Todo[] = this.todos.filter((todo) => todo.status === true);
    ...
    editTodo(index: number) {
      ...
      this.hide(index);
      let objectEdit = this.$refs.valueEdit as [];
      console.log(objectEdit);
      let edit = objectEdit[index] as HTMLInputElement;
      edit.readOnly = false;
    ...
    doneEdit(todo: Todo, index: number) {
      let selectorEdit = this.$refs.valueEdit as [];
      let seletorInputCheck = this.$refs.inputtingCheck as [];
      let afterEdit = selectorEdit[index] as HTMLInputElement;
      let input = seletorInputCheck[index] as HTMLInputElement;
    ...
    hide(index: number) {
      let selectorInput = this.$refs.inputtingCheck as [];
      let selectorTrash = this.$refs.trashClose as [];
      let input = selectorInput[index] as HTMLInputElement;
      let trash = selectorTrash[index] as HTMLIFrameElement;
